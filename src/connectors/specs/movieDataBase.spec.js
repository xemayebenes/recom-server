...
describe('CONNECTOR MOVIE DATA BASE', () => {
  ...
  describe('generate urls', () => {
    describe('generateSearchFilmUriRequest', () => {
      const expected =
        'https://api.themoviedb.org/3/search/movie?api_key=apiKeyTest&language=es&query=foo';

      it('should return the right url', () => {
        expect(connector.generateSearchFilmUriRequest('foo', 'es')).toEqual(
          expected
        );
      });
    });
    ...
    describe('generateGetVideoTVUriRequest', () => {
      const expected =
        'https://api.themoviedb.org/3/tv/id1/videos?api_key=apiKeyTest';
    ...
    describe('generateGetVideoMovieUriRequest', () => {
      const expected =
        'https://api.themoviedb.org/3/movie/id1/videos?api_key=apiKeyTest';

      it('should return the right url', () => {
        expect(connector.generateGetVideoMovieUriRequest('id1')).toEqual(
          expected
        );
      });
    });
    ...
    describe('generateSearchTvUriRequest', () => {
      const expected =
        'https://api.themoviedb.org/3/search/tv?api_key=apiKeyTest&language=es&query=foo';

      it('should return the right url', () => {
        expect(connector.generateSearchTvUriRequest('foo', 'es')).toEqual(
          expected
        );
      });
    });
    ...
    describe('generateGetMovieUriRequest', () => {
      const expected =
        'https://api.themoviedb.org/3/movie/foo?api_key=apiKeyTest&language=es';

      it('should return the right url', () => {
        expect(connector.generateGetMovieUriRequest('foo', 'es')).toEqual(
          expected
        );
      });
    });
    ...
    describe('generateGeTVUriRequest', () => {
      const expected =
        'https://api.themoviedb.org/3/tv/foo?api_key=apiKeyTest&language=es';
  ...
  describe('normalize data', () => {
    describe('normalizeItemData', () => {
      const expected = {
        ...
        images: {
          small: {
            main: 'https://image.tmdb.org/t/p/w92/path1',
            secondary: 'https://image.tmdb.org/t/p/w300/path2'
          },
          medium: {
            main: 'https://image.tmdb.org/t/p/w500/path1',
            secondary: 'https://image.tmdb.org/t/p/w780/path2'
          },
          large: {
            main: 'https://image.tmdb.org/t/p/w780/path1',
            secondary: 'https://image.tmdb.org/t/p/w1280/path2'
          }
        }
      };
      const data = {
